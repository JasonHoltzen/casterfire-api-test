<script>
	import ActiveIcon from '$icons/matdes/Eye.svelte';
	import InactiveIcon from '$icons/matdes/EyeOff.svelte';
	...
	<span class="icon">
		{#if (toggled && hovered) || (!toggled && !hovered)}
			<span transition:fade>
				<InactiveIcon {...iconHiddenProps} />
			</span>
		{:else}
			<span transition:fade>
				<ActiveIcon {...iconVisibleProps} />
			</span>
		{/if}
	</span>
	<span class="text">

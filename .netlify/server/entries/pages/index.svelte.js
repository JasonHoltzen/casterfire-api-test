...
const DeleteForeverOutline = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let { size = "1em" } = $$props;
  ...
  return `<svg${(0, import_index_dfe95557.a)("width", width, 0)}${(0, import_index_dfe95557.a)("height", height, 0)}${(0, import_index_dfe95557.a)("viewBox", viewBox2, 0)}><path d="${"M14.12,10.47L12,12.59L9.87,10.47L8.46,11.88L10.59,14L8.47,16.12L9.88,17.53L12,15.41L14.12,17.53L15.53,16.12L13.41,14L15.53,11.88L14.12,10.47M15.5,4L14.5,3H9.5L8.5,4H5V6H19V4H15.5M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19M8,9H16V19H8V9Z"}"${(0, import_index_dfe95557.a)("fill", color, 0)}></path></svg>`;
});
const ChevronDown = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let { size = "1em" } = $$props;
  let { width = size } = $$props;
  let { height = size } = $$props;
  let { color = "currentColor" } = $$props;
  ...
  if ($$props.viewBox === void 0 && $$bindings.viewBox && viewBox2 !== void 0)
    $$bindings.viewBox(viewBox2);
  return `<svg${(0, import_index_dfe95557.a)("width", width, 0)}${(0, import_index_dfe95557.a)("height", height, 0)}${(0, import_index_dfe95557.a)("viewBox", viewBox2, 0)}><path d="${"M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z"}"${(0, import_index_dfe95557.a)("fill", color, 0)}></path></svg>`;
});
...
const DropdownReveal = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let iconProps;
  let { id = "" } = $$props;
  let { labelText } = $$props;
  ...
  return `<div class="${"dropdown svelte-w7ygob"}"${(0, import_index_dfe95557.a)("style", defaultVars, 0)}><label class="${["svelte-w7ygob", ""].join(" ").trim()}"><input type="${"checkbox"}"${(0, import_index_dfe95557.a)("id", id, 0)} class="${"svelte-w7ygob"}"${(0, import_index_dfe95557.a)("checked", checked, 1)}>
		${labelText ? `<span class="${"text svelte-w7ygob"}">${(0, import_index_dfe95557.e)(labelText)}</span>` : ``}
		<span class="${(0, import_index_dfe95557.e)((0, import_index_dfe95557.h)("icon")) + " svelte-w7ygob"}">${(0, import_index_dfe95557.v)(Icon || import_index_dfe95557.m, "svelte:component").$$render($$result, Object.assign(iconProps, {
    color: btnIconColor
  }), {}, {})}</span></label>
	${``}
</div>`;
});
const FilterDropdown = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.ddBgColor === void 0 && $$bindings.ddBgColor && ddBgColor !== void 0)
    $$bindings.ddBgColor(ddBgColor);
  return `${(0, import_index_dfe95557.v)(DropdownReveal, "Dropdown").$$render($$result, Object.assign(staticProps, { labelText }, { id }, { ddBgColor }), {}, {
...
const Eye = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let { size = "1em" } = $$props;
  let { width = size } = $$props;
  let { height = size } = $$props;
  let { color = "currentColor" } = $$props;
...
const ButtonShowAll = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<button ${btnDisabled ? "disabled" : ""} class="${"svelte-33jqb6"}"><span class="${"icon svelte-33jqb6"}">${(0, import_index_dfe95557.v)(Eye, "BtnIcon").$$render($$result, Object.assign(iconProps, { color: "var(--c-gray-lighter)" }), {}, {})}</span>
...
const Action1 = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
...
const Action2 = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
...
const Action3 = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
...
const Reaction = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
...
const Free = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
...
const SpellAction = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let { action } = $$props;
  if ($$props.action === void 0 && $$bindings.action && action !== void 0)
    $$bindings.action(action);
  return `${action === "1" ? `${(0, import_index_dfe95557.v)(Action1, "Action1").$$render($$result, {}, {}, {})}` : `${action === "2" ? `${(0, import_index_dfe95557.v)(Action2, "Action2").$$render($$result, {}, {}, {})}` : `${action === "3" ? `${(0, import_index_dfe95557.v)(Action3, "Action3").$$render($$result, {}, {}, {})}` : `${action === "reaction" ? `${(0, import_index_dfe95557.v)(Reaction, "Reaction").$$render($$result, {}, {}, {})}` : `${(0, import_index_dfe95557.v)(Free, "Free").$$render($$result, {}, {}, {})}`}`}`}`}`;
});
...
const DdActions = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let btnDisabled;
  ...
  do {
    ...
    $$rendered = `${(0, import_index_dfe95557.v)(FilterDropdown, "FilterDropdown").$$render($$result, { labelText, id }, {}, {
      content: () => `<fieldset slot="${"content"}" class="${"svelte-48som7"}"><legend>Show any with</legend>
		<ul class="${"options svelte-48som7"}"><li class="${"showAll svelte-48som7"}">${(0, import_index_dfe95557.v)(ButtonShowAll, "ButtonShowAll").$$render($$result, { btnDisabled }, {
        btnDisabled: ($$value) => {
          btnDisabled = $$value;
          $$settled = false;
        }
      }, { default: () => `Show All` })}</li>
			${(0, import_index_dfe95557.f)(const_actions, (act) => `<li class="${"action"}"><input type="${"checkbox"}" id="${"action" + (0, import_index_dfe95557.e)(act)}"${(0, import_index_dfe95557.a)("name", act, 0)}${(0, import_index_dfe95557.a)("value", act, 0)} class="${"svelte-48som7"}"${~$filters.actions.indexOf(act) ? (0, import_index_dfe95557.a)("checked", true, 1) : ""}>
					<label for="${"action" + (0, import_index_dfe95557.e)(act)}" class="${(0, import_index_dfe95557.e)((0, import_index_dfe95557.h)(act)) + " svelte-48som7"}">${(0, import_index_dfe95557.v)(SpellAction, "SpellAction").$$render($$result, { action: act }, {}, {})}</label>
				</li>`)}</ul></fieldset>`
    })}`;
  } while (!$$settled);
  $$unsubscribe_filters();
...
const DdComponents = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let btnDisabled;
  let $filters, $$unsubscribe_filters;
  $$unsubscribe_filters = (0, import_index_dfe95557.d)(import_spellForm_a6ab5089.f, (value) => $filters = value);
  ...
  $$unsubscribe_filters();
  return `${(0, import_index_dfe95557.v)(FilterDropdown, "FilterDropdown").$$render($$result, {
    labelText,
    id,
    ...
    content: () => `<fieldset slot="${"content"}" class="${"svelte-1big96g"}"><div class="${"header svelte-1big96g"}"><legend>Show spells matching all</legend>
			<div class="${"showAll svelte-1big96g"}"><button ${btnDisabled ? "disabled" : ""} class="${"svelte-1big96g"}"><span class="${"icon svelte-1big96g"}">${(0, import_index_dfe95557.v)(Eye, "BtnIcon").$$render($$result, Object.assign(iconProps, { color: "var(--c-gray-lighter)" }), {}, {})}</span>
		...
		<ul class="${"categories svelte-1big96g"}"><li><h4 class="${"svelte-1big96g"}">Cast times</h4>
				<ul class="${"options svelte-1big96g"}">${(0, import_index_dfe95557.f)(const_components.times, (t) => `<li class="${"trait"}"><input type="${"checkbox"}" id="${"trait" + (0, import_index_dfe95557.e)(t)}"${(0, import_index_dfe95557.a)("name", t, 0)}${(0, import_index_dfe95557.a)("value", t, 0)} class="${"svelte-1big96g"}"${~$filters.components.indexOf(t) ? (0, import_index_dfe95557.a)("checked", true, 1) : ""}>
							<label for="${"trait" + (0, import_index_dfe95557.e)(t)}" class="${(0, import_index_dfe95557.e)((0, import_index_dfe95557.h)(t)) + " svelte-1big96g"}">${(0, import_index_dfe95557.e)(t)}</label>
						</li>`)}</ul></li>
			<li><h4 class="${"svelte-1big96g"}">Cast requirements</h4>
				<ul class="${"options svelte-1big96g"}">${(0, import_index_dfe95557.f)(const_components.requirements, (r) => `<li class="${"trait"}"><input type="${"checkbox"}" id="${"trait" + (0, import_index_dfe95557.e)(r.replace(/\s+/g, ""))}"${(0, import_index_dfe95557.a)("name", r.replace(/\s+/g, ""), 0)}${(0, import_index_dfe95557.a)("value", r.replace(/\s+/g, ""), 0)} class="${"svelte-1big96g"}"${~$filters.components.indexOf(r.replace(/\s+/g, "")) ? (0, import_index_dfe95557.a)("checked", true, 1) : ""}>
							<label for="${"trait" + (0, import_index_dfe95557.e)(r.replace(/\s+/g, ""))}" class="${(0, import_index_dfe95557.e)((0, import_index_dfe95557.h)(r)) + " svelte-1big96g"}">${(0, import_index_dfe95557.e)(r)}</label>
...
const RemoveFilterButton = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
...
const CloseCircle = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let { size = "1em" } = $$props;
  let { width = size } = $$props;
  let { height = size } = $$props;
  let { color = "currentColor" } = $$props;
  ...
  if ($$props.viewBox === void 0 && $$bindings.viewBox && viewBox2 !== void 0)
    $$bindings.viewBox(viewBox2);
  return `<svg${(0, import_index_dfe95557.a)("width", width, 0)}${(0, import_index_dfe95557.a)("height", height, 0)}${(0, import_index_dfe95557.a)("viewBox", viewBox2, 0)}><path d="${"M12,2C17.53,2 22,6.47 22,12C22,17.53 17.53,22 12,22C6.47,22 2,17.53 2,12C2,6.47 6.47,2 12,2M15.59,7L12,10.59L8.41,7L7,8.41L10.59,12L7,15.59L8.41,17L12,13.41L15.59,17L17,15.59L13.41,12L17,8.41L15.59,7Z"}"${(0, import_index_dfe95557.a)("fill", color, 0)}></path></svg>`;
});
const CloseCircleOutline = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let { size = "1em" } = $$props;
  let { width = size } = $$props;
  let { height = size } = $$props;
  let { color = "currentColor" } = $$props;
  ...
  if ($$props.viewBox === void 0 && $$bindings.viewBox && viewBox2 !== void 0)
    $$bindings.viewBox(viewBox2);
  return `<svg${(0, import_index_dfe95557.a)("width", width, 0)}${(0, import_index_dfe95557.a)("height", height, 0)}${(0, import_index_dfe95557.a)("viewBox", viewBox2, 0)}><path d="${"M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2C6.47,2 2,6.47 2,12C2,17.53 6.47,22 12,22C17.53,22 22,17.53 22,12C22,6.47 17.53,2 12,2M14.59,8L12,10.59L9.41,8L8,9.41L10.59,12L8,14.59L9.41,16L12,13.41L14.59,16L16,14.59L13.41,12L16,9.41L14.59,8Z"}"${(0, import_index_dfe95557.a)("fill", color, 0)}></path></svg>`;
});
const FilterRemove = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let { size = "1em" } = $$props;
  let { width = size } = $$props;
  let { height = size } = $$props;
  let { color = "currentColor" } = $$props;
...
const FiltersApplied = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let $appliedFilters, $$unsubscribe_appliedFilters;
  $$unsubscribe_appliedFilters = (0, import_index_dfe95557.d)(import_spellForm_a6ab5089.g, (value) => $appliedFilters = value);
  ...
  return `${$appliedFilters.length > 0 ? `<ul class="${"svelte-1a77gl0"}"><li class="${"svelte-1a77gl0"}">${(0, import_index_dfe95557.v)(RemoveFilterButton, "RemoveFilterButton").$$render($$result, {}, {}, {
    hoveredIcon: () => `${(0, import_index_dfe95557.v)(FilterRemove, "ClearAllHoverIcon").$$render($$result, Object.assign(clearIconHoverProps, { slot: "hoveredIcon" }), {}, {})}`,
    defaultIcon: () => `${(0, import_index_dfe95557.v)(FilterRemoveOutline, "ClearAllIcon").$$render($$result, Object.assign(clearIconProps, { slot: "defaultIcon" }), {}, {})}`,
    buttonText: () => `Clear All`
  })}</li>
		${(0, import_index_dfe95557.f)($appliedFilters, (_filter) => `<li class="${"svelte-1a77gl0"}">${(0, import_index_dfe95557.v)(RemoveFilterButton, "RemoveFilterButton").$$render($$result, {}, {}, {
    hoveredIcon: () => `${(0, import_index_dfe95557.v)(CloseCircle, "RemoveIconHover").$$render($$result, Object.assign(removeIconHoverProps, { slot: "hoveredIcon" }), {}, {})}`,
    defaultIcon: () => `${(0, import_index_dfe95557.v)(CloseCircleOutline, "RemoveIcon").$$render($$result, Object.assign(RemoveIconProps, { slot: "defaultIcon" }), {}, {})}`,
    buttonText: () => `${(0, import_index_dfe95557.e)((0, import_spellForm_a6ab5089.h)(_filter))}
					`
  })}
			</li>`)}</ul>` : ``}`;
});
const ArrowDownThick = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let { size = "1em" } = $$props;
  let { width = size } = $$props;
  let { height = size } = $$props;
  let { color = "currentColor" } = $$props;
  ...
  if ($$props.viewBox === void 0 && $$bindings.viewBox && viewBox2 !== void 0)
    $$bindings.viewBox(viewBox2);
  return `<svg${(0, import_index_dfe95557.a)("width", width, 0)}${(0, import_index_dfe95557.a)("height", height, 0)}${(0, import_index_dfe95557.a)("viewBox", viewBox2, 0)}><path d="${"M10,4H14V13L17.5,9.5L19.92,11.92L12,19.84L4.08,11.92L6.5,9.5L10,13V4Z"}"${(0, import_index_dfe95557.a)("fill", color, 0)}></path></svg>`;
});
...
const Incrementer = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let { id } = $$props;
  ...
  return `<div class="${"wrapper svelte-ru1cxg"}"><input type="${"number"}"${(0, import_index_dfe95557.a)("min", min, 0)}${(0, import_index_dfe95557.a)("max", max, 0)} ${disabled ? "disabled" : ""}${(0, import_index_dfe95557.a)("placeholder", placeholder, 0)}${(0, import_index_dfe95557.a)("id", id, 0)}${(0, import_index_dfe95557.a)("name", id, 0)} class="${"svelte-ru1cxg"}"${(0, import_index_dfe95557.a)("value", number, 0)}>
	<button aria-label="${"decrement " + (0, import_index_dfe95557.e)(placeholder)}" class="${"minus svelte-ru1cxg"}" ${disabled || number === min ? "disabled" : ""}><span class="${"icon svelte-ru1cxg"}">${(0, import_index_dfe95557.v)(ArrowDownThick, "Arrow").$$render($$result, Object.assign(iconProps, { color: "var(--c-gray-lighter" }), {}, {})}</span>
		${``}</button>

	<button aria-label="${"increment " + (0, import_index_dfe95557.e)(placeholder)}" class="${"plus svelte-ru1cxg"}" ${disabled ? "disabled" : ""}><span class="${"icon svelte-ru1cxg"}">${(0, import_index_dfe95557.v)(ArrowDownThick, "Arrow").$$render($$result, Object.assign(iconProps, { color: "var(--c-gray-lighter)" }), {}, {})}</span>
		${``}</button>
</div>`;
});
const LessThanOrEqual = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let { size = "1em" } = $$props;
  let { width = size } = $$props;
  let { height = size } = $$props;
  let { color = "currentColor" } = $$props;
  ...
  if ($$props.viewBox === void 0 && $$bindings.viewBox && viewBox2 !== void 0)
    $$bindings.viewBox(viewBox2);
  return `<svg${(0, import_index_dfe95557.a)("width", width, 0)}${(0, import_index_dfe95557.a)("height", height, 0)}${(0, import_index_dfe95557.a)("viewBox", viewBox2, 0)}><path d="${"M18.5,2.27L5,10.14L18.5,18L19.5,16.27L8.97,10.14L19.5,4L18.5,2.27M5,20V22H20V20H5Z"}"${(0, import_index_dfe95557.a)("fill", color, 0)}></path></svg>`;
});
const GreaterThanOrEqual = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let { size = "1em" } = $$props;
  let { width = size } = $$props;
  let { height = size } = $$props;
  let { color = "currentColor" } = $$props;
  ...
  if ($$props.viewBox === void 0 && $$bindings.viewBox && viewBox2 !== void 0)
    $$bindings.viewBox(viewBox2);
  return `<svg${(0, import_index_dfe95557.a)("width", width, 0)}${(0, import_index_dfe95557.a)("height", height, 0)}${(0, import_index_dfe95557.a)("viewBox", viewBox2, 0)}><path d="${"M6.5,2.27L20,10.14L6.5,18L5.5,16.27L16.03,10.14L5.5,4L6.5,2.27M20,20V22H5V20H20Z"}"${(0, import_index_dfe95557.a)("fill", color, 0)}></path></svg>`;
});
const Equal = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let { size = "1em" } = $$props;
  let { width = size } = $$props;
  let { height = size } = $$props;
  let { color = "currentColor" } = $$props;
  ...
  if ($$props.viewBox === void 0 && $$bindings.viewBox && viewBox2 !== void 0)
    $$bindings.viewBox(viewBox2);
  return `<svg${(0, import_index_dfe95557.a)("width", width, 0)}${(0, import_index_dfe95557.a)("height", height, 0)}${(0, import_index_dfe95557.a)("viewBox", viewBox2, 0)}><path d="${"M19,10H5V8H19V10M19,16H5V14H19V16Z"}"${(0, import_index_dfe95557.a)("fill", color, 0)}></path></svg>`;
});
const Cancel = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let { size = "1em" } = $$props;
  let { width = size } = $$props;
  let { height = size } = $$props;
  let { color = "currentColor" } = $$props;
...
const DdLevel = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let $filters, $$unsubscribe_filters;
  $$unsubscribe_filters = (0, import_index_dfe95557.d)(import_spellForm_a6ab5089.f, (value) => $filters = value);
  let { labelText = "No Label Text" } = $$props;
  let { id = "level" } = $$props;
  ...
  do {
    ...
    $$rendered = `${(0, import_index_dfe95557.v)(FilterDropdown, "FilterDropdown").$$render($$result, { labelText, id }, {}, {
      content: () => `<ul class="${"svelte-1x0h6lp"}"><li class="${"svelte-1x0h6lp"}"><fieldset class="${"svelte-1x0h6lp"}"><legend class="${"svelte-1x0h6lp"}">Spell level is</legend>
					<input type="${"radio"}" name="${"notFiltered"}" id="${"notFiltered"}" ${!$filters.level.equality ? "checked" : ""} value="${""}" class="${"svelte-1x0h6lp"}"${$filters.level.equality === "" ? (0, import_index_dfe95557.a)("checked", true, 1) : ""}>
					<label for="${"notFiltered"}" class="${"cancel svelte-1x0h6lp"}"><span class="${"icon svelte-1x0h6lp"}">${(0, import_index_dfe95557.v)(Cancel || import_index_dfe95557.m, "svelte:component").$$render($$result, Object.assign(iconButtonProps, { color: "var(--c-gray-light)" }), {}, {})}</span></label>

					${(0, import_index_dfe95557.f)(levelOptions, (_opt) => `<input type="${"radio"}"${(0, import_index_dfe95557.a)("value", _opt.value, 0)}${(0, import_index_dfe95557.a)("id", _opt.value, 0)}${(0, import_index_dfe95557.a)("name", _opt.value, 0)} ${$filters.level.equality === _opt.value ? "checked" : ""} class="${"svelte-1x0h6lp"}"${_opt.value === $filters.level.equality ? (0, import_index_dfe95557.a)("checked", true, 1) : ""}>
						<label${(0, import_index_dfe95557.a)("for", _opt.value, 0)} class="${"svelte-1x0h6lp"}"><span class="${"icon svelte-1x0h6lp"}">${(0, import_index_dfe95557.v)(_opt.icon || import_index_dfe95557.m, "svelte:component").$$render($$result, Object.assign(iconButtonProps, { color: "var(--c-gray-lighter)" }), {}, {})}</span>
						</label>`)}</fieldset></li>
			<li class="${"svelte-1x0h6lp"}"><label class="${"hidden svelte-1x0h6lp"}" for="${"levelNumber"}">Level number: </label>
				${(0, import_index_dfe95557.v)(Incrementer, "Incrementer").$$render($$result, {
        id: "levelNumber",
        name: "levelNumber",
        min: "1",
        max: "10",
...
const SearchBar = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let $filters, $$unsubscribe_filters;
  $$unsubscribe_filters = (0, import_index_dfe95557.d)(import_spellForm_a6ab5089.f, (value) => $filters = value);
  $$result.css.add(css$8);
  $$unsubscribe_filters();
  return `<label class="${"svelte-obccrn"}">Search
	<input type="${"text"}" placeholder="${"name or description"}" class="${"svelte-obccrn"}"${(0, import_index_dfe95557.a)("value", $filters.search, 0)}>
</label>`;
});
const EyeOff = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let { size = "1em" } = $$props;
  let { width = size } = $$props;
  let { height = size } = $$props;
  let { color = "currentColor" } = $$props;
...
const FilterCheckButton = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let id;
  ...
  id = text.replaceAll(" ", "");
  return `<input${(0, import_index_dfe95557.a)("name", id, 0)}${(0, import_index_dfe95557.a)("id", id, 0)} type="${"checkbox"}" class="${"svelte-12gds7p"}"${(0, import_index_dfe95557.a)("checked", toggled, 1)}>
<label${(0, import_index_dfe95557.a)("for", id, 0)} class="${(0, import_index_dfe95557.e)((0, import_index_dfe95557.h)(toggled ? "on" : "off")) + " svelte-12gds7p"}"><span class="${"icon svelte-12gds7p"}">${toggled && hovered || !toggled && !hovered ? `<span class="${"svelte-12gds7p"}">${(0, import_index_dfe95557.v)(EyeOff, "InactiveIcon").$$render($$result, Object.assign(iconHiddenProps), {}, {})}</span>` : `<span class="${"svelte-12gds7p"}">${(0, import_index_dfe95557.v)(Eye, "ActiveIcon").$$render($$result, Object.assign(iconVisibleProps), {}, {})}</span>`}</span>
	<span class="${"text svelte-12gds7p"}">${(0, import_index_dfe95557.e)(text)}</span>
</label>`;
});
...
const DdSources = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let $filters, $$unsubscribe_filters;
  ...
  do {
    $$settled = true;
    $$rendered = `${(0, import_index_dfe95557.v)(FilterDropdown, "FilterDropdown").$$render($$result, { labelText, id }, {}, {
      content: () => `<ul slot="${"content"}" class="${"svelte-t5nnfi"}">${(0, import_index_dfe95557.v)(FilterCheckButton, "FilterCheckbox").$$render($$result, {
        text: "Rulebook",
		...
		${(0, import_index_dfe95557.v)(FilterCheckButton, "FilterCheckbox").$$render($$result, {
        text: "Custom",
		...
		${$selectedCharacter._id ? `${(0, import_index_dfe95557.v)(FilterCheckButton, "FilterCheckbox").$$render($$result, {
...
const DdTraits = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let btnDisabled;
  let $filters, $$unsubscribe_filters;
  $$unsubscribe_filters = (0, import_index_dfe95557.d)(import_spellForm_a6ab5089.f, (value) => $filters = value);
  ...
  do {
    ...
    $$rendered = `${(0, import_index_dfe95557.v)(FilterDropdown, "FilterDropdown").$$render($$result, {
      labelText,
      id,
      ddBgColor: "var(--c-s-dark)"
    }, {}, {
      content: () => `<fieldset slot="${"content"}" class="${"svelte-16le761"}"><div class="${"header svelte-16le761"}"><legend>Show spells matching all</legend>
			${(0, import_index_dfe95557.v)(ButtonShowAll, "ButtonShowAll").$$render($$result, { btnDisabled }, {
        btnDisabled: ($$value) => {
          btnDisabled = $$value;
          $$settled = false;
        }
      }, { default: () => `Show All` })}</div>
		<ul class="${"categories svelte-16le761"}">${(0, import_index_dfe95557.f)(const_traits, (t) => `<li><h4 class="${"svelte-16le761"}">${(0, import_index_dfe95557.e)(t.category)}</h4>
					<ul class="${"options svelte-16le761"}">${(0, import_index_dfe95557.f)(t.traits.sort(), (t2) => `<li class="${"trait"}"><input type="${"checkbox"}" id="${"trait" + (0, import_index_dfe95557.e)(t2)}"${(0, import_index_dfe95557.a)("name", t2, 0)}${(0, import_index_dfe95557.a)("value", t2, 0)} class="${"svelte-16le761"}"${~$filters.traits.indexOf(t2) ? (0, import_index_dfe95557.a)("checked", true, 1) : ""}>
								<label for="${"trait" + (0, import_index_dfe95557.e)(t2)}" class="${(0, import_index_dfe95557.e)((0, import_index_dfe95557.h)(t2)) + " svelte-16le761"}">${(0, import_index_dfe95557.e)(t2)}</label>
							</li>`)}</ul>
				</li>`)}</ul></fieldset>`
    })}`;
  } while (!$$settled);
...
const DdTraditions = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let btnDisabled;
  let $filters, $$unsubscribe_filters;
  $$unsubscribe_filters = (0, import_index_dfe95557.d)(import_spellForm_a6ab5089.f, (value) => $filters = value);
  ...
  do {
    ...
    $$rendered = `${(0, import_index_dfe95557.v)(FilterDropdown, "FilterDropdown").$$render($$result, {
      ...
      content: () => `<fieldset slot="${"content"}" class="${"svelte-rbogao"}"><legend class="${"svelte-rbogao"}">Show matching all</legend>
		<div class="${"buttonContainer svelte-rbogao"}">${(0, import_index_dfe95557.v)(ButtonShowAll, "ButtonShowAll").$$render($$result, { btnDisabled }, {
        btnDisabled: ($$value) => {
          btnDisabled = $$value;
          $$settled = false;
        }
      }, { default: () => `Show All` })}</div>
		${(0, import_index_dfe95557.f)(const_traditions, (t) => `<div><input${(0, import_index_dfe95557.a)("id", t, 0)} type="${"checkbox"}"${(0, import_index_dfe95557.a)("value", t, 0)} class="${"svelte-rbogao"}"${~$filters.traditions.indexOf(t) ? (0, import_index_dfe95557.a)("checked", true, 1) : ""}>
				<label style="${"--tColor: var(--" + (0, import_index_dfe95557.e)(t) + ")"}"${(0, import_index_dfe95557.a)("for", t, 0)} class="${"svelte-rbogao"}">${(0, import_index_dfe95557.e)(t)}</label>
			</div>`)}</fieldset>`
    })}`;
  } while (!$$settled);
  $$unsubscribe_filters();
...
const FilterMenu = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let { size = "1em" } = $$props;
  let { width = size } = $$props;
  let { height = size } = $$props;
  let { color = "currentColor" } = $$props;
  ...
  if ($$props.viewBox === void 0 && $$bindings.viewBox && viewBox2 !== void 0)
    $$bindings.viewBox(viewBox2);
  return `<svg${(0, import_index_dfe95557.a)("width", width, 0)}${(0, import_index_dfe95557.a)("height", height, 0)}${(0, import_index_dfe95557.a)("viewBox", viewBox2, 0)}><path d="${"M11 11L16.76 3.62A1 1 0 0 0 16.59 2.22A1 1 0 0 0 16 2H2A1 1 0 0 0 1.38 2.22A1 1 0 0 0 1.21 3.62L7 11V16.87A1 1 0 0 0 7.29 17.7L9.29 19.7A1 1 0 0 0 10.7 19.7A1 1 0 0 0 11 18.87V11M13 16L18 21L23 16Z"}"${(0, import_index_dfe95557.a)("fill", color, 0)}></path></svg>`;
});
...
const FilterBar2 = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let filtersActive;
  let $filters, $$unsubscribe_filters;
  let $selectedCharacter, $$unsubscribe_selectedCharacter;
  let $appliedFilters, $$unsubscribe_appliedFilters;
  ...
  {
    {
      if ($filters.characterSpells.isolate && ($selectedCharacter == null ? void 0 : $selectedCharacter._id)) {
        (0, import_index_dfe95557.j)(import_spellForm_a6ab5089.f, $filters.characterSpells.spellbook = [...$selectedCharacter.spellbook], $filters);
      } else {
        (0, import_index_dfe95557.j)(import_spellForm_a6ab5089.f, $filters.characterSpells.spellbook = [], $filters);
      }
    }
  }
  $$unsubscribe_filters();
  $$unsubscribe_selectedCharacter();
  $$unsubscribe_appliedFilters();
  return `<menu class="${"svelte-lifcd6"}"><div class="${"filterHeader svelte-lifcd6"}"><button class="${"iconButton filter svelte-lifcd6"}">${`<span class="${"svelte-lifcd6"}">${(0, import_index_dfe95557.v)(FilterMenu, "FilterMenuIcon").$$render($$result, Object.assign(iconButtonProps), {}, {})}</span>`}</button>
		<div class="${"appliedfilters svelte-lifcd6"}"><h2 class="${"svelte-lifcd6"}">Spell Filters
				<button class="${(0, import_index_dfe95557.e)((0, import_index_dfe95557.h)(appliedOpen ? "iconButton chevron rotate" : "iconButton chevron")) + " svelte-lifcd6"}" ${!filtersActive ? "disabled" : ""}><span class="${"svelte-lifcd6"}">${(0, import_index_dfe95557.v)(ChevronDown, "ExpandIcon").$$render($$result, Object.assign(iconButtonProps), {}, {})}</span></button></h2>
			${appliedOpen ? `${(0, import_index_dfe95557.v)(FiltersApplied, "FiltersApplied").$$render($$result, {}, {}, {})}` : ``}</div>
		<div class="${"search svelte-lifcd6"}">${(0, import_index_dfe95557.v)(SearchBar, "SearchBar").$$render($$result, {}, {}, {})}</div></div>
	${`<hr class="${"svelte-lifcd6"}">
		<div class="${"filterBox svelte-lifcd6"}">${(0, import_index_dfe95557.v)(DdSources, "SourcesDD").$$render($$result, { labelText: "Sources" }, {}, {})}
			<span class="${"separator svelte-lifcd6"}"></span>
			${(0, import_index_dfe95557.v)(DdActions, "ActionsDD").$$render($$result, { labelText: "Actions" }, {}, {})}
			${(0, import_index_dfe95557.v)(DdComponents, "ComponentsDD").$$render($$result, { labelText: "Components" }, {}, {})}
			${(0, import_index_dfe95557.v)(DdLevel, "LevelDD").$$render($$result, { labelText: "Spell Level" }, {}, {})}
			${(0, import_index_dfe95557.v)(DdTraits, "TraitsDD").$$render($$result, { labelText: "Traits" }, {}, {})}
			${(0, import_index_dfe95557.v)(DdTraditions, "TraditionsDD").$$render($$result, { labelText: "Traditions" }, {}, {})}</div>`}
</menu>`;
});
...
const SpellSelector = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let hideMobile;
  let $selectedSpell, $$unsubscribe_selectedSpell;
  let $$unsubscribe_modal;
  let $user, $$unsubscribe_user;
  let $filteredSpells, $$unsubscribe_filteredSpells;
  $$unsubscribe_selectedSpell = (0, import_index_dfe95557.d)(import_spellForm_a6ab5089.i, (value) => $selectedSpell = value);
  ...
  $$unsubscribe_filteredSpells = (0, import_index_dfe95557.d)(import_spellForm_a6ab5089.j, (value) => $filteredSpells = value);
  ...
  return `<aside class="${["svelte-i3ruo3", hideMobile ? "hideMobile" : ""].join(" ").trim()}"><ul class="${"svelte-i3ruo3"}">${($user == null ? void 0 : $user.name) ? `<li class="${"stickyButtonContainer svelte-i3ruo3"}"><button class="${"newSpellButton svelte-i3ruo3"}">New Custom Spell
		...
		${!$filteredSpells ? `<li class="${"svelte-i3ruo3"}"><label for="${"noop"}" class="${"svelte-i3ruo3"}"><input type="${"radio"}" name="${"noop"}" value="${"null"}" class="${"svelte-i3ruo3"}">
					<div class="${"svelte-i3ruo3"}"><span class="${"svelte-i3ruo3"}">No spell data</span>
						<span class="${"svelte-i3ruo3"}">...waiting</span></div></label></li>` : `${(0, import_index_dfe95557.f)($filteredSpells, (_spell) => `<li class="${"svelte-i3ruo3"}"><label${(0, import_index_dfe95557.a)("for", _spell.id, 0)} class="${"svelte-i3ruo3"}"><input type="${"radio"}"${(0, import_index_dfe95557.a)("name", _spell.id, 0)}${(0, import_index_dfe95557.a)("value", _spell, 0)} class="${"svelte-i3ruo3"}"${_spell === $selectedSpell ? (0, import_index_dfe95557.a)("checked", true, 1) : ""}>
						<div class="${"svelte-i3ruo3"}"><span class="${"svelte-i3ruo3"}">${(0, import_index_dfe95557.e)(_spell.name)}
								${_spell.custom ? `<sup class="${"svelte-i3ruo3"}">custom</sup>` : ``}</span>
							<span class="${"typeInfo svelte-i3ruo3"}">${(0, import_index_dfe95557.e)(_spell.type ? _spell.type.charAt(0).toLowerCase() : "")}-${(0, import_index_dfe95557.e)(_spell.level)}</span>
						</div></label>
				</li>`)}`}</ul>
</aside>`;
});
const ApplicationImport = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let { size = "1em" } = $$props;
  let { width = size } = $$props;
  let { height = size } = $$props;
  let { color = "currentColor" } = $$props;
...
const SquareEditOutline = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.viewBox === void 0 && $$bindings.viewBox && viewBox2 !== void 0)
    $$bindings.viewBox(viewBox2);
  return `<svg${(0, import_index_dfe95557.a)("width", width, 0)}${(0, import_index_dfe95557.a)("height", height, 0)}${(0, import_index_dfe95557.a)("viewBox", viewBox2, 0)}><path d="${"M5,3C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V12H19V19H5V5H12V3H5M17.78,4C17.61,4 17.43,4.07 17.3,4.2L16.08,5.41L18.58,7.91L19.8,6.7C20.06,6.44 20.06,6 19.8,5.75L18.25,4.2C18.12,4.07 17.95,4 17.78,4M15.37,6.12L8,13.5V16H10.5L17.87,8.62L15.37,6.12Z"}"${(0, import_index_dfe95557.a)("fill", color, 0)}></path></svg>`;
});
...
const SpellDetails = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let md_description;
  let c_times;
  let c_reqs;
  let hasOr;
  ...
  let $$unsubscribe_modal;
  let $user, $$unsubscribe_user;
  $$unsubscribe_selectedSpell = (0, import_index_dfe95557.d)(import_spellForm_a6ab5089.i, (value) => value);
  $$unsubscribe_modal = (0, import_index_dfe95557.d)(import_spellForm_a6ab5089.m, (value) => value);
  $$unsubscribe_user = (0, import_index_dfe95557.d)(import_spellForm_a6ab5089.u, (value) => $user = value);
  let { name = "" } = $$props;
  let { type = "" } = $$props;
...
${``}
<div class="${"headerRow svelte-1xnbngb"}"><h2 class="${"svelte-1xnbngb"}">${(0, import_index_dfe95557.e)(name)}${custom ? `<sup class="${"svelte-1xnbngb"}">**</sup>` : ``}</h2>
	<span class="${"typeLevel svelte-1xnbngb"}">${(0, import_index_dfe95557.e)(type)}\xA0${(0, import_index_dfe95557.e)(level)}</span>
	${!!$user.name ? `<div class="${"buttonGroup svelte-1xnbngb"}">${custom ? `<button class="${"edit svelte-1xnbngb"}">${(0, import_index_dfe95557.v)(SquareEditOutline, "SpellEditExistingIcon").$$render($$result, {}, {}, {})}
					<span class="${"text svelte-1xnbngb"}">Edit</span></button>` : ``}
			<button class="${"copy svelte-1xnbngb"}">${(0, import_index_dfe95557.v)(ApplicationImport, "SpellCopyEditIcon").$$render($$result, {}, {}, {})}
				<span class="${"text svelte-1xnbngb"}">Copy &amp; Edit </span></button>
			${custom ? `<button class="${"delete svelte-1xnbngb"}">${(0, import_index_dfe95557.v)(DeleteForeverOutline, "SpellDeleteIcon").$$render($$result, {}, {}, {})}
					<span class="${"text svelte-1xnbngb"}">Delete spell</span></button>` : ``}</div>` : ``}</div>
<hr class="${"svelte-1xnbngb"}">
${traits ? `<ul class="${"traits svelte-1xnbngb"}">${traits ? `${(0, import_index_dfe95557.f)(traits, (_trait) => `<li${(0, import_index_dfe95557.a)("name", _trait.toLowerCase(), 0)} class="${(0, import_index_dfe95557.e)((0, import_index_dfe95557.h)(_trait.toLowerCase())) + " svelte-1xnbngb"}">${(0, import_index_dfe95557.e)(_trait)}
				</li>`)}` : ``}</ul>` : ``}
${!!traditions && traditions.length > 0 ? `<span class="${"spellProperty svelte-1xnbngb"}"><strong class="${"svelte-1xnbngb"}">Traditions:\xA0</strong>
		<ul class="${"traditions svelte-1xnbngb"}">${(0, import_index_dfe95557.f)(traditions, (_tradition) => `<li${(0, import_index_dfe95557.a)("name", _tradition.toLowerCase(), 0)} class="${(0, import_index_dfe95557.e)((0, import_index_dfe95557.h)(_tradition.toLowerCase())) + " svelte-1xnbngb"}">${(0, import_index_dfe95557.e)(_tradition)}
				</li>`)}</ul></span>` : ``}

${components || action || range || area || duration || targets || savingThrow ? `${components || action ? `<span class="${"spellProperty svelte-1xnbngb"}"><strong class="${"svelte-1xnbngb"}">Cast:\xA0</strong>
			${!!action && action.length > 0 ? `${(0, import_index_dfe95557.f)(action, (item, index) => `${(0, import_index_dfe95557.v)(SpellAction, "SpellAction").$$render($$result, { action: item }, {}, {})}
					${action.length === 2 && index !== action.length - 1 ? `\xA0to` : ``}
					\xA0`)}
				${action.length > 0 && c_times.length > 0 ? `to` : ``}` : ``}
			${c_times.length > 0 ? `${(0, import_index_dfe95557.f)(c_times, (item) => `${(0, import_index_dfe95557.e)(item)}`)}` : ``}
			${c_reqs.length > 0 ? `(
				${(0, import_index_dfe95557.f)(c_reqs, (item, index) => `${(0, import_index_dfe95557.e)(item)}${index < c_reqs.length - 1 ? `,` : ``}
...
<footer class="${"svelte-1xnbngb"}">${custom ? `<span class="${"custom svelte-1xnbngb"}">** denotes a custom spell</span>` : ``}
	${source ? `<span class="${"source"}">${(0, import_index_dfe95557.e)(source)}</span>` : ``}</footer>
...
const ArrowLeftThick = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let { size = "1em" } = $$props;
  let { width = size } = $$props;
  let { height = size } = $$props;
  let { color = "currentColor" } = $$props;
  ...
  if ($$props.viewBox === void 0 && $$bindings.viewBox && viewBox2 !== void 0)
    $$bindings.viewBox(viewBox2);
  return `<svg${(0, import_index_dfe95557.a)("width", width, 0)}${(0, import_index_dfe95557.a)("height", height, 0)}${(0, import_index_dfe95557.a)("viewBox", viewBox2, 0)}><path d="${"M20,10V14H11L14.5,17.5L12.08,19.92L4.16,12L12.08,4.08L14.5,6.5L11,10H20Z"}"${(0, import_index_dfe95557.a)("fill", color, 0)}></path></svg>`;
});
const BookmarkPlusOutline = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let { size = "1em" } = $$props;
  let { width = size } = $$props;
  let { height = size } = $$props;
  let { color = "currentColor" } = $$props;
  ...
  if ($$props.viewBox === void 0 && $$bindings.viewBox && viewBox2 !== void 0)
    $$bindings.viewBox(viewBox2);
  return `<svg${(0, import_index_dfe95557.a)("width", width, 0)}${(0, import_index_dfe95557.a)("height", height, 0)}${(0, import_index_dfe95557.a)("viewBox", viewBox2, 0)}><path d="${"M17,18V5H7V18L12,15.82L17,18M17,3A2,2 0 0,1 19,5V21L12,18L5,21V5C5,3.89 5.9,3 7,3H17M11,7H13V9H15V11H13V13H11V11H9V9H11V7Z"}"${(0, import_index_dfe95557.a)("fill", color, 0)}></path></svg>`;
});
const BookmarkMinusOutline = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let { size = "1em" } = $$props;
  let { width = size } = $$props;
  let { height = size } = $$props;
  let { color = "currentColor" } = $$props;
  ...
  if ($$props.viewBox === void 0 && $$bindings.viewBox && viewBox2 !== void 0)
    $$bindings.viewBox(viewBox2);
  return `<svg${(0, import_index_dfe95557.a)("width", width, 0)}${(0, import_index_dfe95557.a)("height", height, 0)}${(0, import_index_dfe95557.a)("viewBox", viewBox2, 0)}><path d="${"M9,11V9H15V11H9M19,5V21L12,18L5,21V5C5,3.89 5.9,3 7,3H17C18.11,3 19,3.9 19,5M17,5H7V18L12,15.82L17,18V5Z"}"${(0, import_index_dfe95557.a)("fill", color, 0)}></path></svg>`;
});
var spellViewer_svelte_svelte_type_style_lang = "";
const { Object: Object_1 } = import_index_dfe95557.k;
const css = {
...
const SpellViewer = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  let $selectedSpell, $$unsubscribe_selectedSpell;
  let $selectedCharacter, $$unsubscribe_selectedCharacter;
  ...
  $$unsubscribe_selectedSpell = (0, import_index_dfe95557.d)(import_spellForm_a6ab5089.i, (value) => $selectedSpell = value);
  $$unsubscribe_selectedCharacter = (0, import_index_dfe95557.d)(import_spellForm_a6ab5089.a, (value) => $selectedCharacter = value);
  $$unsubscribe_characters = (0, import_index_dfe95557.d)(import_spellForm_a6ab5089.c, (value) => value);
  $$unsubscribe_user = (0, import_index_dfe95557.d)(import_spellForm_a6ab5089.u, (value) => $user = value);
  ...
  $$unsubscribe_user();
  return `${Object.keys($selectedSpell).length > 0 ? `<main class="${"svelte-14a4wty"}"><div class="${"controls svelte-14a4wty"}">${($selectedCharacter == null ? void 0 : $selectedCharacter.characterName) && ($selectedCharacter == null ? void 0 : $selectedCharacter._id) ? `${$selectedCharacter.spellbook.includes($selectedSpell._id) ? `<button aria-label="${"Remove spell from character"}" class="${"spellAddDelButton svelte-14a4wty"}">${(0, import_index_dfe95557.v)(BookmarkMinusOutline, "RemoveSpellIcon").$$render($$result, Object_1.assign(addRemoveIconProps), {}, {})}
						<span class="${"text svelte-14a4wty"}">Remove from spellbook </span></button>` : `<button aria-label="${"Add spell to character"}" class="${"spellAddDelButton svelte-14a4wty"}">${(0, import_index_dfe95557.v)(BookmarkPlusOutline, "AddSpellIcon").$$render($$result, Object_1.assign(addRemoveIconProps), {}, {})}
			...
			<button aria-label="${"close spell"}" class="${"closeButton svelte-14a4wty"}">${(0, import_index_dfe95557.v)(import_spellForm_a6ab5089.C, "CloseIcon").$$render($$result, Object_1.assign(addRemoveIconProps), {}, {})}</button></div>
		${(0, import_index_dfe95557.v)(SpellDetails, "SpellDetails").$$render($$result, Object_1.assign($selectedSpell), {}, {})}</main>` : `<main class="${"nospell svelte-14a4wty"}"><div class="${"message svelte-14a4wty"}"><p class="${"xl"}">Well, that&#39;s bold, trying to cast a spell before you pick one.</p>
			<p class="${"xl"}">Try over there</p>
			${(0, import_index_dfe95557.v)(ArrowLeftThick, "ArrowLeftThick").$$render($$result, Object_1.assign(arrowIconProps), {}, {})}</div></main>`}`;
});
const Routes = (0, import_index_dfe95557.c)(($$result, $$props, $$bindings, slots) => {
  return `${(0, import_index_dfe95557.v)(FilterBar2, "FilterBar2").$$render($$result, {}, {}, {})}
${(0, import_index_dfe95557.v)(SpellSelector, "SpellSelector").$$render($$result, {}, {}, {})}
${(0, import_index_dfe95557.v)(SpellViewer, "SpellViewer").$$render($$result, {}, {}, {})}`;
});
